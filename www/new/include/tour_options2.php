...
function chng_setOption(obj,n,dft)
{
	var div = obj.value;

	var fm = document.getElementById('chng_category'+n+'_step2');
	var fm2 = document.getElementById('chng_category'+n+'_step3');
...
function chng_setOption2(obj,n,dft)
{
	var div = obj.value;
	var fm = document.getElementById('chng_category'+n+'_step3');
...
function chng_setOption2th(div)
{
	var fm = document.fmData.chng_category2_step2;
	var fm2 = document.fmData.chng_category2_step3;
	clearOption(fm);
	clearOption(fm2);
...
function chng_setOption2th2(div)
{
	var fm = document.fmData.chng_category2_step3;
	clearOption(fm);
	if(div==''){
	}
	<?
