...
.r{padding-right:5px !important}
    ...
    if($ctype == '기타(없음)'){$filter = " and ISNULL(b.nation)";}
    ...
    <table border="0" cellspacing="0" cellpadding="3" width="100%" id="tbl_cmp_list">
        ...
        ?>
        <tr>
            <td rowspan="2" style="background-color:#f0f0f0"><a href="list_paper17.php?date_s=<?=$date_s?>&date_e=<?=$date_e?>&ctype=<?=$ctype?>&city=<?=$val?>&dtype=<?=$dtype?>"><?=$val?></a></td>
            <td>금년</td>
