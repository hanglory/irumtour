...
<head>
    ...
    <style>
        ...
        #menu_wrap .option input {border: 1px solid gray;padding: 3px;}
        #menu_wrap .option button {margin-left:2px;border: 1px solid gray;padding: 3px;}
