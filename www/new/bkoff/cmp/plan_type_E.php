...
?>
		...
		<table width="<?=$page_width?>" border="0" cellspacing="1" cellpadding="0" style="border-collapse:collapse;border:1px solid #ccc;width:<?=$page_width?>px">
		  ...
		  <tr>
            ...
            <td align="center" bgcolor="#ffffff" style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;padding:5px;color:<?=$color_time?>">
		  ...
		  <tr>
            ...
            <td align="center" bgcolor="#ffffff" style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;padding:5px;color:<?=$color_time?>"><?=$d_time_e?></td>
            <td align="left"  bgcolor="#ffffff" style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;padding-left:5px;font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';">
			<?=$airport_out?> 도착
			</td>
          </tr>
		  <tr>
            ...
            <td align="center" bgcolor="#ffffff" style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;vertical-align:top;color:<?=$color_time?>">
		  ...
		  $j=0;
		  for($i=2; $i<$night_all-$night_all_m;$i++){
			...
			//if($_SERVER["REMOTE_ADDR"]=="106.246.54.27"){checkVar($i,$long_days_i);}
		  ?>
		  <tr>
			...
			if($golf_cnt){
				...
				for($gn=0; $gn < $golf_cnt;$gn++){
					...
					if($GOLF_PIC[$j][$gn]) $golf_img.= "<img src='http://irumtour.net/new/public/cmp/" . $GOLF_PIC[$j][$gn] . "' width='180' height='130' class='$bit r_${gn}'>";
		  ...
		  <tr>
			...
			if($golf_cnt){
				...
				for($gn=0; $gn < $golf_cnt;$gn++){
					...
					if($GOLF_PIC[$j2][$gn]) $golf_img.= "<img src='http://irumtour.net/new/public/cmp/" . $GOLF_PIC[$j2][$gn] . "' width='180' height='130' class='$bit r_${gn}'>";
		  ...
		  <tr>
            ...
            <td align="center" bgcolor="#ffffff" style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;padding:5px;color:<?=$color_time?>"><?=$r_time_s?></td>
