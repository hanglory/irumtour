...
?>
		<table width="<?=$page_width?>" border="0" cellspacing="1" cellpadding="0" style="border-collapse:collapse;border:1px solid #ccc ">
		  ...
		  if($bit_long_days){
			$night_all=3;
			$pre_day_i = $night - 1;
			$long_days_txt = "<br>~<br>제${pre_day_i}일";
		  }
		  ...
		  <tr>
			...
			<?
			//if($_SERVER["REMOTE_ADDR"]=="106.246.54.27"){checkVar("j",$j);}
			//골프장 이미지
			$golf_pic_width= 370;
		  ...
		  <tr>
            <td height="25" align="center" bgcolor="<?=$bg_color?>" style="font-size:10pt;font-family:'Malgun Gothic','돋움';line-height:130%;font-family:'Malgun Gothic','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;color:#FFF;font-weight:bold" rowspan="3">제<?=$night?>일<br><?=full_date(date("Y/m/d",strtotime($r_date." -1 day")))?></td>
		  ...
		  ?>
		  <tr>
            <td height="70" align="center" bgcolor="<?=$bg_color?>" style="font-size:10pt;font-family:'Malgun Gothic','돋움';line-height:130%;font-family:'Malgun Gothic','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;color:#FFF;font-weight:bold">제<?=$night?>일<br><?=full_date($r_date)?></td>            <td align="center" bgcolor="#ffffff" style="font-size:10pt;font-family:'Malgun Gothic','돋움';line-height:130%;font-family:'Malgun Gothic','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;padding:5px">
            	<?=$r_airport_place?>
