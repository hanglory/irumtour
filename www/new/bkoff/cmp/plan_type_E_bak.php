...
?>
		...
		<table width="<?=$page_width?>" border="0" cellspacing="1" cellpadding="0" style="border-collapse:collapse;border:1px solid #ccc;width:<?=$page_width?>px">
          <tr>
            <td height="25" align="center" bgcolor="#948A54" style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;padding:5px"><span style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';font-weight:bold;color:#FFF">일자</span></td>
            <td width="10%" align="center" bgcolor="#948A54" style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;padding:5px"><span style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';font-weight:bold;color:#FFF">지역</span></td>
            <td width="10%" align="center" bgcolor="#948A54" style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;padding:5px"><span style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';font-weight:bold;color:#FFF">교통편</span></td>
            <td width="6%" align="center" bgcolor="#948A54" style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;padding:5px"><span style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';font-weight:bold;color:#FFF">시간</span></td>
            <td width="60%" align="center" bgcolor="#948A54" style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;padding:5px"><span style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';font-weight:bold;color:#FFF">여행일정</span></td>
            <td width="15%" align="center" bgcolor="#948A54" style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;padding:5px"><span style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';font-weight:bold;color:#FFF">비고</span></td>
          </tr>

		  <tr>
            <td height="25" align="center" bgcolor="#948A54" rowspan="4" style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;padding:5px;color:#FFF;font-weight:bold">제1일<br/><?=full_date($d_date)?></td>
		  ...
		  if($bit_long_days){
			...
			$gap=1;
			$pre_day_i = $night-2;
			$long_days_txt = "<p style='color:#fff'>~</p>제${pre_day_i}일" . full_date(date("Y/m/d",strtotime($r_date." -2 day")));
		  }


		  $j=0;
		  for($i=$start; $i<$night_all-1;$i++){
		  ...
		  ?>
		  <tr>
            <td height="25" align="center" bgcolor="#948A54" style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;color:#FFF;font-weight:bold" rowspan="2">제<?=$i+$gap?>일<br><?=full_date(date("Y/m/d",strtotime($d_date." +$j2 day")))?> <?=$long_days_txt?></td>
            <td align="center" bgcolor="#ffffff" style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;padding:5px">
		  ...
		  <tr>
            <td height="25" align="center" bgcolor="#948A54" style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;color:#FFF;font-weight:bold" rowspan="2">제<?=$night-1?>일<br><?=full_date(date("Y/m/d",strtotime($r_date." -1 day")))?></td>
            <td align="center" bgcolor="#ffffff" style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;padding:5px">
		  ...
		  <tr>
            <td height="25" align="center" bgcolor="#948A54" style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;color:#FFF;font-weight:bold" rowspan="3">제<?=$night?>일<br><?=full_date($r_date)?></td>
            <td align="center" bgcolor="#ffffff" style="font-size:10pt;font-family:'나눔고딕','맑은고딕','돋움';line-height:130%;font-family:'나눔고딕','맑은고딕','돋움';border-left:1px solid #ccc;border-bottom:1px solid #ccc;padding:5px">
            	<?=$r_airport_place?>
