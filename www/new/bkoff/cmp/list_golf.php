...
####검색 항목
$selectTxt = "상품명,공항지역,지역,거래처,담당자,미팅보드,상품코드";
$selectValue ="name,air_city,city,partner,main_staff,meeting_board,id_no";



#### Link
$keyword2 = base64_encode($keyword);
$link = "keyword=$keyword&target=$target&ctg1=$ctg1&best=$best&nation=$nation";
$sessLink = $link;
?>
<?include("../top.html");?>
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="right">
			 <tr>
			  ...
			  <td align="right">
				...
				<span class="btn_pack medium bold"><a href="list_golf_excel.php?position=<?=$position?>&ctg1=<?=$ctg1?>&nation=<?=$nation?>&target=<?=$target?>&keyword=<?=$keyword?>"> 엑셀 </a></span>&nbsp;
                <?}?>
