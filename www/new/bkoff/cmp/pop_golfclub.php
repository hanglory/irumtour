...
####검색 항목
$selectTxt = "Club Name,State,City,Club ID";
...
?>
	    <tr align='center' onMouseOver="this.style.backgroundColor='#EEEEFF'" onMouseOut="this.style.backgroundColor='#FFFFFF'">
	      ...
	      <td><?=$rs[state]?></td>
		  <td><?=$rs[city]?></td>
	      <td class="l" style="padding-left:10px"><a href="javascript:newWin('view_golfclub.php?club_id=<?=$rs[club_id]?>',800,600,1,1,'golf_courses')"><?=$rs[club_name]?></a></td>
