...
.red{color:red !important;}	
	...
	<?=option_str("입출금,예약일,출국일,출금일1,출금일2,출금일3,입금일1,입금일2,입금일3","total,b.tour_date,b.d_date,a.date_out,a.date_out2,a.date_out3,a.date_in,a.date_in2,a.date_in3",$target2)?>
	</select>
    ...
    <table border="0" cellspacing="0" cellpadding="3" width="100%" id="tbl_cmp_list">
        ...
        <tr align="center" height="25" bgcolor="#F7F7F6">
            ...
            <th class="r pr10" style="text-align: right !important" rowspan="2"><span class="htxt_price1 ">0</span></th>
            <th class="r pr10 blue" style="text-align: right !important"><span class="htxt_price2 ">0</span></th>
            <th></th>
            <th class="r pr10 blue" style="text-align: right !important"><span class="htxt_price3 ">0</span></th>
            <th></th>      
            <th class="r pr10 blue" style="text-align: right !important"><span class="htxt_price4 ">0</span></th>
            <th></th>
            <th class="r pr10 red" style="text-align: right !important"><span class="htxt_price45 ">0</span></th>
            <th></th>
            <th class="r pr10 red" style="text-align: right !important"><span class="htxt_price6 ">0</span></th>
            <th></th>
            <th class="r pr10 red" style="text-align: right !important"><span class="htxt_price7 ">0</span></th>
            <th></th>
            <th></th>      
        </tr>
        <tr align=center height=25 bgcolor="#F7F7F6">
            <th class="r pr10 blue" colspan="5" style="text-align: right !important"><span class="htxt_price8 ">0</span></th>
            <th></th>
            <th></th>
            <th class="r pr10 red" colspan="4" style="text-align: right !important"><span class="htxt_price9 ">0</span></th>
            <th></th>      
            <th></th>      
        </tr>        
...
?>
	    <tr align=center height=25 bgcolor="#F7F7F6">
    		<th class="subject" colspan="2" rowspan="2">합계</th>
    		<th class="r pr10" style="text-align: right !important" rowspan="2"><span class="txt_price1"><?=nf($sum1)?></span></th>
    		<th class="r pr10 blue" style="text-align: right !important"><span class="txt_price2"><?=nf($sum2)?></span></th>
    		<th class="subject" ></th>
    		<th class="r pr10 blue" style="text-align: right !important"><span class="txt_price3"><?=nf($sum3)?></span></th>
    		<th class="subject" ></th>		
    		<th class="r pr10 blue" style="text-align: right !important"><span class="txt_price4"><?=nf($sum7)?></span></th>
    		<th class="subject" ></th>
    		<th class="r pr10 red" style="text-align: right !important"><span class="txt_price5"><?=nf($sum4)?></span></th>
    		<th class="subject" ></th>
    		<th class="r pr10 red" style="text-align: right !important"><span class="txt_price6"><?=nf($sum6)?></span></th>
    		<th class="subject" ></th>
    		<th class="r pr10 red" style="text-align: right !important"><span class="txt_price7"><?=nf($sum8)?></span></th>
    		<th class="subject" ></th>
    		<th class="subject" ></th>		
		</tr>
        <tr align=center height=25 bgcolor="#F7F7F6">
            <th class="r pr10 blue" colspan="5" style="text-align: right !important"><span class="txt_price8"><?=nf($sum2+$sum3+$sum7)?></span></th>
            <th class="subject" ></th>
            <th class="subject" ></th>
            <th class="r pr10 red" colspan="4" style="text-align: right !important"><span class="txt_price9"><?=nf($sum4+$sum6+$sum8)?></span></th>
            <th class="subject" ></th>      
            <th class="subject" ></th>      
        </tr>
	</table>
