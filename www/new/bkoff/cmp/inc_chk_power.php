...
if($_SESSION["sessLogin"]["staff_type"]!="ceo"){
    ...
    $power_exception_files .="@list_daily.php@";  
    ...
    if(!strstr($power_exception_files,SELF)){//개인정보 수정은 제외
        ...
        if($_SESSION['sessLogin']['staff_type']!="ceo"){
            ...
            if($sess_proof_erp){
                ...
                $MENU_CHK_NAME["list_reservation.php"]="예약관리";
                $MENU_CHK_NAME["list_bank.php"]="입출금관리";
                $MENU_CHK_NAME["list_paper1.php"]="경영관리";
                $MENU_CHK_NAME["list_paper2.php"]="매출현황";
    ...
    $sql_ = "select * from cmp_staff where id='".$_SESSION["sessLogin"]["id"]."' limit 1";
    $dbo_->query($sql_);
