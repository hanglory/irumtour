...
$filter = ($cp_id && strstr($_SESSION["sessLogin"]["staff_type"],"partner"))? " and CID='$cp_id'":" and (CID is null or CID='')";

if($CID && strstr("@ceo@staff@leader@",$_SESSION["sessLogin"]["staff_type"])){
    $filter = " and CID='$CID'";
}
...
#### Link
$link = "keyword=$keyword&target=$target&sort=$sort&CID=$CID";
...
//-->
    ...
    <table border="0" cellspacing="0" cellpadding="3" width="100%" id="tbl_list">
       ...
       <input type="hidden" name="mode" value="drop">
        ...
        <tr><td colspan="12"  bgcolor='#E1E1E1'></td></tr>
<?
//if(strstr("@14.37.241.55@221.154.110.119@","@".$_SERVER["REMOTE_ADDR"]."@")){checkVar(mysql_error(),$sql2);}
