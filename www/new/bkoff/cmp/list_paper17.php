...
.r{padding-right:5px !important}
    ...
    <table border="0" cellspacing="0" cellpadding="3" width="100%" id="tbl_cmp_list">
	    <tr align="center" height="25" bgcolor="#F7F7F6">
			...
			<!-- <th class="subject" width="12%">기간</th> -->
			<th class="subject" width="12%">인원</th>
			<th class="subject" width="12%">비율</th>
			<th class="subject" width="12%">매출</th>
			<th class="subject" width="12%">객단가</th>
		</tr>
		<?
		$total_this1=0;
		$total_this2=0;
		...
		?>
		<tr>
			<td rowspan="1" style="background-color:#f0f0f0"><?=$arr_golfname[$val]?></td>
			<!-- <td>금년</td> -->
		  ...
		  <td colspan="12">
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="right">
				 <tr>
				  ...
				  <td align="right">
					<span class="btn_pack medium bold"><a href="list_<?=$filecode?>_excel.php?date_s=<?=$date_s?>&date_e=<?=$date_e?>&ctype=<?=$ctype?>&city=<?=$city?>&dtype=<?=$dtype?>"> 엑셀 </a></span>
				  </td>
				</tr>
			  </table>
			  <!-- Button End------------------------------------------------>
