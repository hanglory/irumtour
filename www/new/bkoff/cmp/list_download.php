...
.gap{
    ...
    <form name="fm_find" method="get" action="<?=SELF?>">
        <tr height="22">
        <td><font color="#666666">* <?=($status)?> 검색된 예약 건: <?=number_format($row_search)?>개 <?if(!$seq_mode){?>{ <?=number_format($total_page)?> page /  <?=number_format($page)?> page }<?}?></font></td>
        <td valign='bottom' align=right>
            <div style="margin-bottom:5px">


                <strong>인원</strong>&nbsp;&nbsp;
                <input type="text" name="num_s" id="num_s" size="3" maxlength="2" value="<?=$num_s?>" class="box c numberic"> ~
                <input type="text" name="num_e" id="num_e" size="3" maxlength="2" value="<?=$num_e?>" class="box c numberic">명
                <span class="gap">|</span>
                ...
                <input type="text" name="price_s" id="price_s" size="11" maxlength="10" value="<?=$price_s?>" class="box c comma numberic"> ~
                <input type="text" name="price_e" id="price_e" size="11" maxlength="10" value="<?=$price_e?>" class="box c comma numberic">원
                <span class="gap">|</span>
            ...
            <input class=box type="text" name="keyword" size="15" maxlength="40" value='<?=$keyword?>' placeholder="상품명">
...
?>
        ...
        <tr align='center' onMouseOver="this.style.backgroundColor='#EEEEFF'" onMouseOut="this.style.backgroundColor='#FFFFFF'">
          ...
          <td><a href="javascript:newWin('view_reservation.php?id_no=<?=$rs[id_no]?>',1200,650,1,1,'','reservation')" style="<?=$css?>"><?=$rs[leader]?></a></td>
          <td><?=$rs[name]?></td>
          <td><?=$rs[phone]?></td>
        </tr>
        <?}?>
        ...
        <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" align="right">
             <tr>
              ...
              <td align="right">
                <span class="btn_pack medium bold"><a href="list_download_excel.php?gender=<?=$sex?>"> 다운로드 </a></span>&nbsp;
              </td>
            </tr>
          </table>
          <!-- Button End------------------------------------------------>
