...
#query
$sql_1 = "select $column from $table where air<>'' $filter $FILTER_PARTNER_QUERY";			//자료수
...
//-->
	...
	<td align=right width=150 valign=top>
	 <select name="air" onchange="location.href='<?=SELF?>?air='+this.value">
	 <option value="">전체보기</optioni>
	 <?=option_str($AIRLINES,$AIRLINES,$air)?>
	 </select>
    ...
    <table border="0" cellspacing="0" cellpadding="3" width="100%" id="tbl_cmp_list">
       ...
       <input type=hidden name=mode value='drop'>
		...
		<th class="subject">카운터</th>
		<th class="subject">위탁수화물</th>
		<th class="subject">기내수화물</th>
...
?>
	    <tr align='center' onMouseOver="this.style.backgroundColor='#EEEEFF'" onMouseOut="this.style.backgroundColor='#FFFFFF'">
	      ...
	      <td><a href="javascript:newWin('view_<?=$filecode?>.php?id_no=<?=$rs[id_no]?>',870,850,1,1,'','air')"><?=$rs[air]?></a></td>
	      <td><?=$rs[cargo_counter]?></td>
	      <td align="left" style="padding:10px"><?=nl2br($rs[content1])?></td>
	      <td align="left" style="padding:10px"><?=nl2br($rs[content2])?></td>
	    </tr>
<?
	$num--;
}
        ...
        <tr>
		  ...
		  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="right">
			 <tr>
			  ...
			  <td align="right">
				<span class="btn_pack medium bold"><a href="javascript:newWin('view_<?=$filecode?>.php?ctg1=<?=$ctg1?>',870,650,1,1,'air')"> 등록 </a></span>&nbsp;
