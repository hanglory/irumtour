...
?>
	    <tr align='center' onMouseOver="this.style.backgroundColor='#EEEEFF'" onMouseOut="this.style.backgroundColor='#FFFFFF'">
	      ...
	      <td><?=$rs[nation]?></td>
	      <td align="left" style="padding:10px"><a href="javascript:newWin('view_<?=$filecode?>.php?id_no=<?=$rs[id_no]?>',870,500,1,1,'','air')"><?=nl2br($rs[content])?></a></td>
	    </tr>
<?
	$num--;
}
