...
<div style="padding:0 10px 0 10px">
    ...
    <table border="0" cellspacing="0" cellpadding="3" width="97%" id="tbl_list">
        ...
        <tr><td colspan="13" class="tblLine"></td></tr>
		...
		<tr height="35" align='center' onMouseOver="this.style.backgroundColor='#EEEEFF'" onMouseOut="this.style.backgroundColor='#FFFFFF'">
			<td>
				...
				<td><input type="text" name="rn[]" id="rn_<?=$j?>" value="<?=$rs[rn]?>" size="22" maxlength="14" class="box rn" onkeyup="chk_sex(this.valuem<?=$j?>)" /></td>
				<td><input type="text" name="passport_no[]" id="passport_no_<?=$j?>" value="<?=$rs[passport_no]?>" size="20" maxlength="30" class="box" /></td>
				...
				<td><input type="text" name="memo[]" id="memo_<?=$j?>" value="<?=$rs[memo]?>" size="50" maxlength="100" class="box" /></td>
