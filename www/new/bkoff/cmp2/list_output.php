...
chk_power($_SESSION["sessLogin"]["proof"],"출력양식");
...
//-->
	...
	<div style="padding:10px 0 10px 0;">
		<span class="btn_pack medium bold"><a href="javascript:newWin('form05.html?id_no=<?=$rs[id_no]?>',870,650,1,1,'','reservation')">여행사보험 리스트</a></span>
	</div>
...
?>
	    <tr align='center' onMouseOver="this.style.backgroundColor='#EEEEFF'" onMouseOut="this.style.backgroundColor='#FFFFFF'">
	      <td height="35"><a href="javascript:newWin('view_reservation.php?id_no=<?=$rs[id_no]?>',870,650,1,1,'','reservation')"><?=$rs[name]?></a></td>
	      <td><?=$rs[tour_date]?></td>
	      <td><?=$rs[d_date]?></td>
	      <td><?=$rs[r_date]?></td>
	      <td><?=nf($rs[people])?></td>
