...
#### Link
$link = $basicLink . "&keyword=$keyword&target=$target&orderby=$orderby&assort=$assort";
...
<?include("../top.html");?>
	...
	<!-- Search Begin------------------------------------------------>
	<table border=0  class="viewWidth" cellspacing="0" cellpadding="0">
	<form name=fmSearch>
...
?>
	<select name="category1" class="select">
		<?=option_str("ALL".$categorys,$categorys,$category1)?>
	</select>

<!-- 	<select name="orderby" class='select' onChange="fmSearch.submit()">
	<?=option_str("제조사순,제조사역순,모델명순,모델명역순","maker,maker desc,model,model desc",$orderby)?>
	</select> -->
...
?>
        ...
        <tr><td colspan=10  bgcolor='#E1E1E1'></td></tr>
<?
	$j++;
	$num--;
}
