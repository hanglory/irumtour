...
if($golf_id_no){
	...
	$filter .= " and (nation='$rs[nation]' or city like '%$rs[city]%')";
}
...
####검색 항목
$selectTxt = "도시,항공사명,출발항공편,도착항공편";
$selectValue ="city,d_air,d_air_no,r_air_no";
...
<!--
function set_air(id_no,d_air_no,r_air_no){
	var str="";
	opener.$("#air_id_no").val(id_no);
	opener.$("#d_air_no").val(d_air_no);
	opener.$("#r_air_no").val(r_air_no);
...
?>
	    <tr align='center' onMouseOver="this.style.backgroundColor='#EEEEFF'" onMouseOut="this.style.backgroundColor='#FFFFFF'">
	      ...
	      <td><?=$rs[r_time_e]?></td>
	      <td><?=$rs[r_wday]?></td>
	      <td><span class="btn_pack medium bold"><a href="#" onClick="set_air('<?=$rs[id_no]?>','<?=$rs[d_air_no]?>','<?=$rs[r_air_no]?>')"> 선택 </a></span></td>
	    </tr>
<?
	$num--;
}
