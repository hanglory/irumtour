...
#query
$sql_1 = "select $column from $table where air<>'' $filter";			//자료수
...
//-->
	...
	<td align=right width=150 valign=top>
	 <select name="air" onchange="document.fmSearch.submit()">
...
?>
	    <tr align='center' onMouseOver="this.style.backgroundColor='#EEEEFF'" onMouseOut="this.style.backgroundColor='#FFFFFF'">
	      ...
	      <td><a href="javascript:newWin('view_<?=$filecode?>.php?id_no=<?=$rs[id_no]?>',870,650,1,1,'','air')"><?=$rs[air]?></a></td>
