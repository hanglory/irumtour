...
function chkForm(){
	...
	<?if($rs[filename]):
		...
		?>
        <tr>
          <td class="subject">이미지<br />433 * 155</td>
          <td height="20">
			...
			<div style="padding:15px 0 15px 0"><img src="../../public/banner/<?=$rs[filename]?>"></div>
          </td>
        </tr>
        <tr><td colspan="2" class="tblLine"></td></tr>
	<?else:?>
		<tr>
          ...
          <td height="20">
            <input class="box" type="file" name="file1" size=40> 433 * 155
          </td>
        </tr>
        <tr><td colspan="2" class="tblLine"></td></tr>
	<?endif;?>
