...
#### Menu
$filecode = "banner";
$TITLE = "Recommended golf Tour 2개";
$MENU = "basic";
$table = "ez_banner1";
...
<?include("../top.html");?>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		<td class="title_con"><img src="../images/common/ic_title.gif" align="absmiddle"><?=$TITLE?> (상위 2개 까지만 화면에 표시됩니다.)</td>
	  </tr>
	  <tr>
		<td> </td>
	  </tr>
...
?>
	    <tr align='center' onMouseOver="this.style.backgroundColor='#EEEEFF'" onMouseOut="this.style.backgroundColor='#FFFFFF'">
	      ...
	      <td><a class=soft href="view_banner.php?id_no=<?=$rs[id_no];?>&assort=<?=$assort?>" onFocus='blur(this)'><img src="../../public/banner/<?=$rs[filename]?>" height="100"></a></td>
