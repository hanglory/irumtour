...
#### Menu
$filecode = "banner2";
$TITLE = "Recommended golf Tour 4개";
$MENU = "basic";
$table = "ez_banner2";
...
<?include("../top.html");?>
    ...
    <table border="0" cellspacing="1" cellpadding="3" class="viewWidth" width="750">
        ...
        <tr>
          <td class="subject" width="25%">text 1</td>
          <td>
        ...
        <tr>
          <td class="subject" width="25%">text 2</td>
          <td>
            <input class="box" type="text" name="text2" value="<?=$rs[text2]?>" size=30 maxlength="70">
          </td>
        </tr>
        <tr><td colspan="2" class="tblLine"></td></tr>
	...
	<?if($rs[filename]):
		...
		?>
        <tr>
          <td class="subject">이미지<br />240 * 100</td>
          <td height="20">
	...
	<?else:?>
		<tr>
          ...
          <td height="20">
            <input class="box" type="file" name="file1" size=40> 240 * 100
          </td>
        </tr>
        <tr><td colspan="2" class="tblLine"></td></tr>
	<?endif;?>
