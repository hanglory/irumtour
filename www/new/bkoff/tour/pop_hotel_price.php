...
if ($mode=="save"){
		...
		for($i=0; $i <count($subject);$i++){
			...
			$qty_add[$i] = price_format($qty_add[$i]);
			$week_normal[$i] = price_format($week_normal[$i]);
			$week_origin[$i] = price_format($week_origin[$i]);
...
//-->
    ...
    <table border="0" cellspacing="1" cellpadding="3" width="95%" align="center">
	    ...
	    <tr>
          ...
          <td class="subject c w10">정원</td>
          <td class="subject c w10">1인추가</td>
          <td class="subject c w10">정가</td>
          <td class="subject c w10">평일</td>
          <td class="subject c w10">주말</td>
	    ...
	    <tr align="center">
          ...
          <td>
		  <input type="text" name="qty_min[]" value="<?=$rs2[qty_min]?>" size="2" maxlength="3" class="box numberic"/>/<input type="text" name="qty_max[]" value="<?=$rs2[qty_max]?>" size="2" maxlength="3" class="box numberic"/>
		  </td>
          <td><input type="text" name="qty_add[]" value="<?=$rs2[qty_add]?>" size="8" maxlength="10" class="box numberic"/></td>
          <td><input type="text" name="week_origin[]" value="<?=$rs2[week_origin]?>" size="8" maxlength="10" class="box numberic"/></td>
          <td><input type="text" name="week_normal[]" value="<?=$rs2[week_normal]?>" size="8" maxlength="10" class="box numberic"/></td>
		...
		<?}?>
		<tr><td colspan="10" class="tblLine"></td></tr>
		<tr><td colspan="10" class="gray sf" style="padding-left:20px">* 정가 기준으로 할인율을 표시합니다.</td></tr>
		<tr>
		  <td colspan=10>
			  <br>
			  <!-- Button Begin---------------------------------------------->
