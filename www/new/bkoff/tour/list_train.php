...
?>
	    <tr align='center' onMouseOver="this.style.backgroundColor='#EEEEFF'" onMouseOut="this.style.backgroundColor='#FFFFFF'" class="lh">
          ...
          <td align="center"><a class=soft href="javascript:newWin('view_<?=$filecode?>.php?id_no=<?=$rs[id_no]?>',870,350,1,1)" onFocus="blur(this)" title="상세정보보기"><?=$rs[subject]?></a></td>
          <td align="center"><?=$rs[station]?></td>
        ...
        <tr>
		  <td colspan="9">
			  ...
			  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="right">
				 <tr>
				  <td></td>
				  <td align="right"><span class="btn_pack medium bold"><a href="javascript:newWin('view_<?=$filecode?>.php',870,350,1,1)"> 등록 </a></span>&nbsp;
