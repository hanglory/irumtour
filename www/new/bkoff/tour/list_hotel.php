...
####검색 항목
$selectTxt = "구분,지역,명칭,소개";
$selectValue ="assort,region,subject,content";
...
function mng_price(code){
	newWin('pop_hotel_price_jeju.php?code='+code,850,800,1,1);
}
    ...
    <table border="0" cellspacing="0" cellpadding="3" width="100%" id="tbl_list">
       ...
       <input type=hidden name=mode value='drop'>
	    ...
	    <tr align=center height="30" bgcolor="#F7F7F6">
			...
			<td class="subject">객실</td>
			<td class="subject">객실/금액</td>
          </tr>
...
?>
	    <tr align='center' onMouseOver="this.style.backgroundColor='#EEEEFF'" onMouseOut="this.style.backgroundColor='#FFFFFF'" class="lh">
          ...
          <td align="center"><a class=soft href="view_<?=$filecode?>.php?id_no=<?=$rs[id_no]?>&<?=$basicLink?>" onFocus="blur(this)" title="상세정보보기"><?=$rs[subject]?></a></td>
          <td align="center"><?=count(explode(",",$rs[rooms]))?>개</td>
          <td align="center"><span class="btn_pack medium bold"><a href="javascript:mng_price(<?=$rs[code]?>)"> 금액 설정 </a></span></td>
	    </tr>
