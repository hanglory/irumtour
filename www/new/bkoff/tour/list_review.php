...
####검색 항목
$selectTxt = "골프장명,국가,지역,내용,답사일";
$selectValue ="name,nation,city,content,ag";
...
?>
	    <tr align='center' onMouseOver="this.style.backgroundColor='#EEEEFF'" onMouseOut="this.style.backgroundColor='#FFFFFF'">
	      ...
	      <td style="text-align:left;padding-left:10px"><?=titleCut2($rs[content],60)?></td>
