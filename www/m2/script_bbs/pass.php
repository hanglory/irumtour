...
<div id="ez_conents_wrap">
	...
	<input type="hidden" name="id_no" value="<?=$id_no?>">
		<div id="pass_box">
			<img src="/renew/images/ez_board/txt_pw.gif" align="absmiddle">
			<input type="password" name="pwd" class="input-text"/>
			<input type="image" src="/renew/public/ez_board/button/<?=$BTN_SUBMIT?>" hspace="4" align="absmiddle" class="border0" />
		</div>
	</form>
	</div>
