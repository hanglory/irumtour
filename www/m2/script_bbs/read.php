...
<div id="ez_conents_wrap">
	...
	<div id="ez_view_btn">
		<ul>
			...
			<li><a href="javascript:drop()"><img src="/renew/public/ez_board/button/<?=$BTN_DELETE?>" /></a></li>
			<li><a href="javascript:edit()"><img src="/renew/public/ez_board/button/<?=$BTN_EDIT?>" /></a></li>
			<?}?>
			<li><a href="?bmode=list&<?=$_SESSION["link"]?>"><img src="/renew/public/ez_board/button/<?=$BTN_LIST?>" /></a></li>
		</ul>
	</div>
	<!-- //-button -->
	...
	<?
	if($BTN_REPLY){
		$reply_pic = "/renew/public/ez_board/button/$BTN_REPLY";
	...
	<div id="ez_view_reply">
		...
		<input type="image" src="/renew/public/ez_board/button/<?=$BTN_REPLY?>" id="btn_comment">
	...
	<div id="ez_view_reply_list">
		...
		<a href="javascript:cmt_drop(<?=$rs[doc_no]?>,<?=$rs[id_no]?>)"> <img src="/renew/images/ez_board/btn_delete.gif" align="absmiddle"></a>
