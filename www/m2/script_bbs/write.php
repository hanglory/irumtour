...
<div id="ez_conents_wrap">
	...
	<!-- bbswrite-button -->
	<div class="right">
		<input type="image" src="/renew/public/ez_board/button/<?=$BTN_SUBMIT?>" class="border0 top"/>
		<a href="#" onclick="cancel()"><img src="/renew/public/ez_board/button/<?=$BTN_CANCEL?>" /></a>
		<a href="?bmode=list&amp;bid=<?=$bid?>"><img src="/renew/public/ez_board/button/<?=$BTN_LIST?>" /></a>
	</div>
	<!-- //bbswrite-button -->
	</form>
