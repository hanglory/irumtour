            ...
            <table summary="일정표" class="tbl_schedule" cellpadding="0" cellspacing="0" >
			  ...
			  <tbody>
               ...
               <tr>
                 ...
                 <td><div class="time2 hide"><?=$d_time_s?></div>개별출발</td>
               </tr>
               ...
               <tr>
                 ...
                 <td><div class="time2 hide"><?=$d_time_e?></div>골프장 도착 후 프론트 체크인</td>
               </tr>
               <tr>
                 <td class="traffic">
					<?
               ...
               <tr>
                 ...
                 <td>
					...
					$arr = explode("<br />",$meal);
					if($arr[1] || $arr[2]){
						$meal_first  = str_replace("식:",":",$arr[1]);
						$meal_first .= str_replace("식:",":",$arr[2]);
					}				
					?>
					<?=ico_meal($meal_first)?>
				 </td>
		  ...
		  <?}?>
               ...
               <tr>
                 ...
                 <td>
					...
					조식 후 체크아웃 골프장으로 이동.<!--  <?=$gh_next?> 소요  --><br/>
					<span class='golfname'>[<?=$golf_name_next?>  라운드]</span> <br/>
               ...
               <tr>
                 ...
                 <td><div class="time2 hide"><?=$r_time_s?></div><?=$r_airport_out?> 라운드 후 개별 이동</td>
               </tr>
               <tr>
                 <td class="traffic"></td>
                 <td class="time"></td>
                 <td>
					...
					$arr = explode("<br />",$meal);
					if($arr[0]){
						$meal_last  = "조:".str_replace("조식:","",$arr[0])."\n";
						$meal_last .= "중:".str_replace("중식:","",$arr[1]);
					}					
					?>					
						<span class="meal_text"><?=(ico_meal($meal_last))?></span>
