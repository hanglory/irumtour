<?
/*new icon 표시*/
function new_icon($wdate,$ico=""){

	$time=time()-86400;

    if(!$ico) $ico="/renew/images/main/ico_new.gif";
...
function bbs_counter_comment($id_no){
	...
	$dbo ->query ("update ez_bbs set cnt_comment=$rows where id_no=$id_no limit 1");
...
function read_img($file){
	...
	$EZ_BOARD_CONFIG_WIDTH = "740";

	if($file){
		$fname = "../new/public/bbs_files/$file";
