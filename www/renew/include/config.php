...
//if($_SERVER["REMOTE_ADDR"]=="106.246.54.27"){checkVar("",__CASTLE_PHP_VERSION_BASE_DIR__."/castle_referee.php");}
...
기본설정
*****************************/
$easeplus=($REMOTE_ADDR=="106.246.54.27")?1:0;
...
//카카오 
$API_KAKAO_ID="98202ca58edce7af994f4b3c3c0c0c48";
...
골프투어문의
*****************************/
$EVENT_NATION = "동남아,태국,필리핀,베트남,일본,중국,미주,기타해외,한국";
$EVENT_AREA1 = "인도네시아,라오스,브루나이";
$EVENT_AREA2 = "훗카이도,후쿠오카,혼슈,미야자키,가고시마,히로시마,오키나와";
$EVENT_AREA3 = "위해,연태,청도,대련,광저우,하이난(해남도)";
$EVENT_AREA4 = "호주,유럽,터키";
$EVENT_AREA5 = "제주도,강원도,전남,전북,경남,경북,충청도";
$EVENT_AREA6 = "방콕,파타야,치앙마이,카오야이,후아힌,푸켓";
$EVENT_AREA7 = "다낭,하노이,나트랑,호치민,달랏,푸꾸옥";
$EVENT_AREA8 = "클락,마닐라,따가이따이";
$EVENT_AREA9 = "하와이,괌,사이판";
...
//if(strstr("@14.37.242.84@221.154.110.119@","@".$_SERVER["REMOTE_ADDR"]."@")) $PROOF_FILTER .=" and cp_id='$CID' ";
...
/*view_cp*/
$BANK_NAMES="신한은행,국민은행,우리은행,농협은행,기업은행,하나은행,씨티은행,sc제일은행";
