	...
	?>
			<tr>
				<td class="subject left bold hand" onclick="view_ans('faq_<?=$num?>')"><img src="images/ez_board/ico_faq_q.gif" width="30"> <?=titleCut(stripslashes($rs[subject]),$EZ_BOARD_CONFIG_LENGTH)?><?=new_icon($rs[reg_date])?>
