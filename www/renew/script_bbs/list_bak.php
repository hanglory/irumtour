	...
	<div id="tbl_bbslist_srch">
		...
		<input type="hidden" name="bid" value="<?=$bid?>">
			<fieldset>
				...
				<input id="bbslistsrch_keyword" type="text" name="keyword" maxlength="40" class="box"/>
				<input type="image" src="public/ez_board/button/<?=$BTN_FIND?>" alt="검색" align="absmiddle" class="border0" />
			</fieldset>
		</form>
	</div>
	<!-- //search -->
