	...
	?>
			<tr>
				<td><?=$num?></td>
				<td class="subject left"><a href="<?=$url?>&l=1" onFocus='blur(this)'><?=titleCut2(stripslashes($rs[subject]),$EZ_BOARD_CONFIG_LENGTH)?></a> <?=$ico_secret?> <?=new_icon($rs[reg_date])?> <?if($SET_MEMO=="T"){?>(<?=number_format($rs[cnt_comment])?>)<?}?></td>
				<td><?=$rs[name]?></td>
				<td><?=date("Y.m.d",$rs[reg_date])?></td>
				<td><?=number_format($rs[cnt])?></td>
			</tr>
