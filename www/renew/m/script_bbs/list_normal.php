	...
	?>
			<tr>
				<td><img src="/new/images/ez_board/ico_notice.gif" align='absmiddle'></td>
				<td class="subject left"><span class="subject100"><a href="<?=$url?>&l=1" onFocus='blur(this)'><?=stripslashes($rs[subject])?></a> <?=$ico_secret?></span></td>
	...
	?>
			<tr>
				<td><?=$num?></td>
				<td class="subject left"><span class="subject100"><a href="<?=$url?>&l=1" onFocus='blur(this)'><?=stripslashes($rs[subject])?></a></span> <?=$ico_secret?> <?=new_icon($rs[reg_date])?> <?if($SET_MEMO=="T"){?>(<?=number_format($rs[cnt_comment])?>)<?}?></td>
				<td><?=date("Y.m.d",$rs[reg_date])?></td>
			</tr>
	<?
		$num--;
