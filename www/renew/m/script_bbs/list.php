...
<div id="ez_conents_wrap">
   ...
   <?if($SET_CATEGORY){?>
	...
	<!-- button -->
	<div class="right">
		<a href="?bmode=write&bid=<?=$bid?>"><img src="/new/public/ez_board/button/<?=$BTN_WRITE?>"></a>
	</div>
	<!-- //button -->
	<?}?>
	...
	<div id="tbl_bbslist_srch">
		...
		<input type="hidden" name="category" id="category" value="<?=$category?>">
			<fieldset>
				...
				<input type="image" src="/new/public/ez_board/button/<?=$BTN_FIND?>" alt="검색" align="absmiddle" class="border0" />
			</fieldset>
		</form>
	</div>
	<!-- //search -->
