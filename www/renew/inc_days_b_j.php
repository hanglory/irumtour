               ...
               <tr>
                 ...
                 <td>
                        ...
                        <?}elseif($gname[0] && $tour_today_name){//골프 후 관광?>
                            ...
                            <span class="bx_inter"><br/><?=${car}?>을 이용하여 골프장으로 이동 <?=${ag1}?> 소요 <br/></span>
                            <span class='golfname'>[<?=$gname[0]?> 라운드]</span>
                        ...
                        <?}else{//관광 없는 경우(기본)?>
                            ...
                            <span class="bx_inter"><br/><?=${car}?>을 이용하여 골프장으로 이동 <?=${ag1}?> 소요 <br/></span>
                            <span class='golfname'>[<?=$gname[0]?>  라운드]</span> <br/>
