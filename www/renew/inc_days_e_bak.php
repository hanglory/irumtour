...
?>
            ...
            <table summary="일정표" class="tbl_schedule" cellpadding="0" cellspacing="0" >
              ...
              <tbody>
               ...
               <?if($plan_add1_d){?>
               <tr>
                 <th scope="row"><?=$plan_add1_a?></th>
                 <td class="traffic"><?=$plan_add1_b?></td>
                 <td class="time"><?=$plan_add1_c?></td>
                 <td><?=$plan_add1_d?></td>
               </tr>
               <?}?>
               <?if($plan_add2_d){?>
               <tr>
                 <th scope="row"><?=$plan_add2_a?></th>
                 <td class="traffic"><?=$plan_add2_b?></td>
                 <td class="time"><?=$plan_add2_c?></td>
                 <td><?=$plan_add2_d?></td>
               </tr>
               <?}?>
               <!-- 추가라인 종료 -->
          ...
          <?}?>
               ...
               <!-- 마지막날 1일전 -->
               <tr>
                  <th colspan="4" scope="col" class="dat_t"><?=$night-1?>days</th>
                </tr>
               <tr>
               ...
               <tr>
                 ...
                 <td><?=$r_airport_out?>으로 이동. <?=$ah2?> 소요<br/><?=$r_airport_out?> 출발</td>
               </tr>
                <tr>
                 <td class="traffic"></td>
                 <td class="time"></td>
               ...
               <?if($plan_add8_d){?>
               <tr>
                 <th scope="row"><?=$plan_add8_a?></th>
                 <td class="traffic"><?=$plan_add8_b?></td>
                 <td class="time"><?=$plan_add8_c?></td>
                 <td><?=$plan_add8_d?></td>
               </tr>
               <?}?>
               <?if($plan_add9_d){?>
               <tr>
                 <th scope="row"><?=$plan_add9_a?></th>
                 <td class="traffic"><?=$plan_add9_b?></td>
                 <td class="time"><?=$plan_add9_c?></td>
                 <td><?=$plan_add9_d?></td>
               </tr>
               <?}?>
               <!-- 추가종료 -->
