...
if($_GET[action]=="upload"){
    ...
    foreach($_FILES['file']['name'] as $i=>$img){
        ...
        if($_FILES["file"]["size"][$i]){
            ...
            $pic = "";
            $pic = $DOMAIN . "/upload/${asp_id}/bbs_files/" . $upfile;
            $file[] = array(
                'url' => $pic
            );
    ...
    //$img =  $data_dir . "rt_SN1639208502.jpg";

    // $file[] = array(
    //     'url' => "https://barotravel.com/main/baro/images/common/logo.png"
    // );


    // $file[] = array(
    //     'url' => "https://barotravel.com/main/baro/images/common/youtube_on.png"
    // );
